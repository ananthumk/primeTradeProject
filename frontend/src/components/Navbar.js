...
const Navbar = () => {
  ...
  return (
    <div className='w-full h-[10vh] shadow-xl shadow-black py-2 flex justify-between px-10 items-center'>
      ...
      {showPopUp &&
        <div className='absolute right-0 top-12 bg-white shadow-md rounded-md py-2 flex flex-col min-w-[120px]'>
          <p className='px-4 py-1 hover:bg-gray-100 cursor-pointer'>Profile</p>
          <p className='flex items-center gap-2 px-4 py-1 hover:bg-gray-100 cursor-pointer'>
